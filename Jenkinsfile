...
pipeline {
    ...
    stages {
        ...
        stage('Pre-Build') {
            ...
            steps {
                script {
                    ...
                    env['url_docker'] = "758526784474.dkr.ecr.us-east-1.amazonaws.com/base-nodejs-bkd-qa${newVersion}"
                }
            ...
            steps {
                script {
                    ...
                    docker.withRegistry("${env.ECR_URL}",'ecr:us-east-1:ecr-private-registry'){
                        def app = docker.build("base-nodejs-bkd-qa")
        ...
        stage ('delete image'){
            ...
            steps{
                script{
                    removeImage('base-nodejs-bkd-qa',env['newVersion'])
                }
            }
        }
...
def notifyBuild(String buildStatus = 'STARTED') {
    ...
    if (buildStatus == 'STARTED') {
        ...
        field.put('value', 'base-nodejs-bkd-qa');
        fields.add(field);
